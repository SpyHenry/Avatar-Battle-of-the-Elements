...
const pathImages = "./src/assets/elements/";
...
const cardData = [
    {
        ...
        name: "Aang",
        type: "Ar",
        img: `${pathImages}air.jpeg`,
        WinOf:[3],  // vence Terra
        LoseOf:[2], // perde para Fogo
    },
    {
        id:1,
        name: "Katara",
        type: "Água",
        img: `${pathImages}water.jpeg`,
        WinOf:[2],  // vence Fogo
        LoseOf:[3], // perde para Terra
    },
    {
        id:2,
        name: "Zuko",
        type: "Fogo",
        img: `${pathImages}fire.jpeg`,
        WinOf:[0],  // vence Ar
        LoseOf:[1], // perde para Água
    },   
    {
        id:3,
        name: "Toph",
        type: "Terra",
        img: `${pathImages}earth.jpeg`,
        WinOf:[1],  // vence Água
        LoseOf:[0], // perde para Ar
    }
];
...
const MAX_SCORE = 10; // condição de vitória
...
async function createCardImage(IdCard, fieldSide){
    ...
    cardImage.setAttribute("src", "./src/assets/images/back.jpg");
...
async function checkDuelResults(playerCardId, ComputerCardId){
    ...
    if(playerCard.WinOf.includes(ComputerCardId)){
        duelResults = "Ganhou";
        await playAudio("swoosh");
        state.score.playerScore++;
    }

    if(playerCard.LoseOf.includes(ComputerCardId)){
        duelResults = "Perdeu";
        await playAudio("fire");
...
async function playAudio(status){
    const audio = new Audio(`./src/assets/audios/${status}.mp3`, type="audio/mp3");
    audio.play();
}
